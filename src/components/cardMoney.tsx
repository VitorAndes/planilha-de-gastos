...
export function CardMoney(props: CardMoneyProps) {
  return (
    <>
      {props.revenue === "Saldo" ? (
        <div className="flex flex-1 md:h-28 flex-col gap-4 bg-gradient-to-b from-emerald-500 via-emerald-500 to-emerald-700 text-primary rounded-md p-4 shadow-md shadow-black">
        ...
        <div className="flex flex-1 md:h-28 flex-col gap-4 bg-gradient-to-b from-rose-500 via-rose-500 to-rose-700 text-primary rounded-md p-4 shadow-md shadow-black">
          <h1 className="text-base md:text-xl font-bold -tracking-tighter flex items-center justify-between gap-2">
