...
export function Footer() {
  return (
    <footer className="flex items-center justify-between bg-gradient-to-t from-my-tertiary to-text-secondary w-full md:h-24 rounded-xl p-4 mt-8 shadow-md shadow-white">
